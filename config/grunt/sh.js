module.exports = (grunt) => {
    ...
    return {
        ...
        'rimraf-source-maps': {
            cmd: 'rimraf build/web-audio-conference-2019/browser/**.map'
        },
        'smoke': {
            cmd: `npx playwright install --with-deps && \
        ...
        'verify': {
            cmd: `npx bundle-buddy build/web-audio-conference-2019/browser/*.js.map && \
                grep -r build/web-audio-conference-2019/browser/*.js.map -e '/environments/environment.ts'; test $? -eq 1`
        }
    };
};
