...
module.exports = {
    chrome: {
        ...
        urls: [
            ...
            `http://localhost:${ port }/slides/23`,
            `http://localhost:${ port }/slides/24`,
            `http://localhost:${ port }/slides/25`,
            `http://localhost:${ port }/slides/26`,
            `http://localhost:${ port }/slides/27`,
            `http://localhost:${ port }/slides/28`,
            `http://localhost:${ port }/slides/29`,
            `http://localhost:${ port }/slides/30`,
            `http://localhost:${ port }/slides/31`,
            `http://localhost:${ port }/slides/32`,
            `http://localhost:${ port }/slides/33`,
            `http://localhost:${ port }/slides/34`,
            `http://localhost:${ port }/slides/35`,
            `http://localhost:${ port }/slides/36`,
            `http://localhost:${ port }/slides/37`
        ]
    }
};
