...
const navigateTo = (path: string) => {
    return browser.get((env.IS_SMOKE_TEST) ? `/web-audio-conference-2019${ path }` : path);
}
...
describe('slides', () => {
    ...
    describe('first slide', () => {
        ...
        it('should look the same', async () => {
            ...
            if (env.TRAVIS) {
                expectElementShot(result).toHaveMismatchWithinRange(19.5, 19.7);
            } else {
    ...
    describe('seventeenth slide', () => {
        ...
        it('should look the same', async () => {
            ...
            if (env.TRAVIS) {
                expectElementShot(result).toHaveMismatchWithinRange(0.7, 0.9);
            } else {
                expectElementShot(result).toBeRegressionFree();
            }
        });
    ...
    describe('thirty seventh slide', () => {
        ...
        it('should look the same', async () => {
            ...
            if (env.TRAVIS) {
                expectElementShot(result).toHaveMismatchWithinRange(60.2, 60.4);
            } else {
                expectElementShot(result).toBeRegressionFree();
            }
        });
